...
import com.eduardo.demoparkapi.web.dto.UsuarioLoginDto;
...
public class AutenticacaoIT {
    ...
    public void autenticar_ComCredenciaisValidas_RetornarTokenComStatus200(){
        JwtAuthentication responseBody = testClient
                .post()
                .uri("/api/v1/auth")
                ...
                .exchange()
                .expectStatus().isOk()
                .expectBody(JwtAuthentication.class)
    ...
    public void autenticar_ComCredenciaisInvalidas_RetornarErrorMessageComstatus400(){
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioLoginDto("ana@email.com", "123222"))
                .exchange()
                .expectStatus().isBadRequest()
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
