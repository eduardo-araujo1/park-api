package com.eduardo.demoparkapi;

import com.eduardo.demoparkapi.web.dto.ClienteCreateDto;
import com.eduardo.demoparkapi.web.dto.ClienteResponseDto;
import com.eduardo.demoparkapi.web.dto.PageableDto;
...
public class ClienteIT {
    ...
    public void criarCliente_ComDadosValidos_RetornarClienteComStatus201(){
        ClienteResponseDto responseBody = testClient
                ...
                .bodyValue(new ClienteCreateDto("Tobias Ferreira", "36044090043"))
                .exchange()
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("36044090043");
    }
    ...
    public void criarCliente_ComDadosInvalidos_RetornarErrorMessageStatus422(){
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "toby@email.com", "123456"))
                .bodyValue(new ClienteCreateDto("I", "00000000000"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "toby@email.com", "123456"))
                .bodyValue(new ClienteCreateDto("I", "360.440.900-43"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    @Test
    public void criarCliente_ComUsuarioNaoPermetido_RetornarErrorMessageStatus403(){
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/clientes")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void buscarCliente_ComDadosDoTokenDoCliente_RetornarClienteComStatus200() {
        ClienteResponseDto responseBody = testClient
                .get()
    ...
    @Test
    public void buscarCliente_ComDadosDoTokenDoAdmin_RetornarErrorMessageComStatus403() {
        ErrorMessage responseBody = testClient
                .get()
                .uri("/api/v1/clientes/detalhes")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
